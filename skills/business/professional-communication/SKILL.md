...
description: Craft clear, professional internal business communications across email, chat, meetings, and documents. Provides channel selection guidance, message structure templates, tone guidelines, and best practices for internal communications. Use when users need to write a professional email, draft a business communication, compose an internal message, craft a business message, or choose the right communication channel for a workplace situation. Make sure to use this skill whenever the user mentions professional communication, internal communication, business messaging, workplace communication, or wants help structuring a professional message, even if they don't explicitly ask for "professional-communication." Do NOT trigger on general coding questions, technical writing, API documentation, marketing copy, customer-facing sales content, or personal/informal emails — this skill is for structured internal business communication, not external marketing or engineering documentation.
version: 1.0.0
...
tags:
  ...
  - "internal-comms"
see-also:
  - skill: biz-email-upsert
    relationship: "related"
    description: "Business email creation framework — use for drafting and reviewing specific business emails with structured templates"
  - skill: task-triage
    relationship: "related"
    description: "Business task organization — use to prioritize work before communicating about it"
---
...
Guidelines for creating clear, professional, and effective internal business
communications. These guidelines apply to **internal communications only**.
...
| Channel | Use For | Best Practice |
|---------|---------|---------------|
| **Email** | Formal announcements, detailed updates, documenting conversations, non-urgent records | Default for most professional communication; asynchronous, respects focus time |
| **Instant Messaging** (Slack, Teams) | Quick questions, informal collaboration, time-sensitive coordination | Can be disruptive; for complex topics, send a brief message suggesting a follow-up |
| **Text Message** | Extremely urgent matters when other channels are unavailable | Avoid for any non-urgent business communication |
| **Phone Call** | Complex or sensitive topics needing real-time nuance but no formal meeting | Send a brief message first; follow up with an email summarizing decisions |
| **Meeting** (in-person or video) | Collaborative work, strategic planning, multi-stakeholder decisions | Schedule only when the objective cannot be achieved asynchronously; always include agenda and pre-reading |

For the full channel selection matrix with decision criteria and edge cases,
see [Channel Selection Matrix](references/channel-selection.md).

## Message Structure

Structure written communications to be as clear and efficient as possible.

### Subject Line

Convey the email's purpose and urgency quickly.

- **Good:** "ACTION REQUIRED: Please Approve Q3 Marketing Budget by EOD Friday"
- **Reconsider:** "Budget"

### Opening — Bottom Line Up Front (BLUF)

State the most important information or the primary action required in the first
sentence.

- **Good:** "The deadline for the project has been moved to October 28th. Details below."
- **Reconsider:** A long paragraph explaining project history before announcing the deadline at the end.

### Body

Keep messages concise. Provide necessary background, but avoid premature or
excessive explanations. If more detail is needed, provide it in a separate
document, thread, or upon request.

### Call to Action

Clearly state what you need from the recipient. Don't make them guess.

- **Good:** "Please review this document and provide your feedback by 3 PM Tuesday."
- **Reconsider:** "Let me know what you think."

### Proofread

Always check for spelling and grammatical errors before sending. Clear,
error-free writing enhances professionalism.

## Tone and Style

Maintain a professional, respectful, and approachable tone in all communications.

- **Disagree respectfully:** "I have a different perspective on this. I'd like
  to discuss it with you."
- **Don't disparage:** Avoid overly critical language when discussing a
  colleague's work; don't contrast excessive praise for leadership with
  criticism of peers.
- **Handle factual inaccuracies collaboratively:** Instead of stating someone
  is wrong, try "That's an interesting perspective. To make sure we're all on
  the same page, could we pull up the data on that?" or "My memory of that is
  slightly different. Can we sync up to confirm the details?"

## Best Practices

### Information Sharing and Dialogue

Proactively share relevant information with all stakeholders. Encourage two-way
dialogue by asking for input and feedback.

- **Do:** "Here is the draft of the project plan. What are your thoughts on this
  approach? Does this align with your priorities?"
- **Don't:** Fail to include a key person on an email chain; use
  passive-aggressive phrasing like "As per my last email..." which shuts down
  conversation.

### Attributing Contributions

Be specific and generous when giving credit. This builds trust and team
cohesion.

- **Do:** "I want to highlight the excellent analysis Jane contributed to this
  report. Here is the work we completed as a team."
- **Don't:** Overstate your own role in a team effort; present a group's work as
  your own.

### Giving Feedback and Praise

Ensure feedback is clear, consistent, and constructive. Praise should be
unambiguous and sincere.

- **Do:** "Your presentation was very effective because the data was clear and
  the key takeaways were well-summarized."
- **Don't:** Give praise that contains a subtle criticism (backhanded
  compliment); make sudden, unexplained shifts in tone from supportive to
  critical.

## Formal and Sensitive Communications

In formal situations — disciplinary action, responding to an employee complaint
— communication must be exceptionally clear, professional, and well-documented.

### Responding to an Employee Complaint

- Acknowledge receipt in a professional and neutral tone
- Focus on process and next steps: "Thank you for bringing this to our
  attention. We take these matters seriously and will review the information in
  accordance with company policy."
- Avoid making admissions or judgments before a review is complete

### Delivering Formal Feedback (e.g., a PIP)

- Tone must be strictly factual, non-emotional, focused on observable behaviors
  and measurable outcomes
- Structure around evidence: dates, metrics, specific examples of work
- Clearly outline expectations, support to be provided, and timeline for
  improvement: "This document outlines specific, measurable performance
  objectives for the next 60 days and the resources we will provide to support
  you in meeting them."
