...
[Quality Gates](../rust-development-practices/quality-gates.md)).
...
- [Quality Gates](../rust-development-practices/quality-gates.md) — CI runs cargo audit + weekly outdated PR
