...
* [Diagram Tool Selection](diagram-tool-selection.md) - Pick the right route (Mermaid, PlantUML, D2, Excalidraw, or editorial HTML/SVG) by output type, version control needs, and rendering environment
...
* [D2 and TALA Practices](d2-tala.md) - D2 text-based diagramming with the TALA orthogonal autolayout engine (open-source MPL-2.0), custom/partial positioning for agentic generation, layout engine selection (TALA vs Dagre vs ELK)
