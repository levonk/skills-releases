...
see-also:
  ...
  - template: "trigger-guard"
    ...
    description: "Over-triggering guard protocol"
  - template: "python-script-standards"
    relationship: "shared-include"
    description: "PEP 723 / uv header requirements for bundled scripts"
  - skill: git-repository-management
    relationship: complement
    description: "Uses ignorefile-manager to update .gitignore as part of commit workflows"
---
