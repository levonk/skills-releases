...
tags: ["ai/skill", "software-development", "github", "issue", "upstream-contribution", "open-source", "filing", "forge", "own-repo"]
see-also:
  - skill: github-pr
    relationship: "complement"
    description: "Creates PRs against upstream or own repos; requires an issue number (creates one inline using this skill's procedure if needed)"
  - template: github-issue-procedure
    relationship: "base-framework"
    description: "Shared issue creation procedure inlined at build time (handles both own-repo and upstream modes)"
...
dependencies:
  - type: system
    ...
    reason: "Required for GitHub API calls (issue search, creation, validation, repo-mode detection)"
  - type: system
    name: curl
