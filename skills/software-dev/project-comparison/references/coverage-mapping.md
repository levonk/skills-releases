...
5. **Use the full scale**: Follow the shared coverage-scale icons reference
   (🏆 best-in-class, ✅ full, ➖ partial, ⚠️ problematic, ❌ missing). Reserve
   🏆 for true standouts, and distinguish ⚠️ (broken/deprecated) from ➖
   (limited) and ❌ (missing).
