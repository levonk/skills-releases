...
EOF
		...
		log_info "OK: Created build.gradle.kts"
	fi
}
...
EOF
		log_info "OK: Created settings.gradle.kts"
	fi
}
...
EOF
			log_info "OK: Created src/test/kotlin/ExampleTest.kt"
		fi
...
EOF
			log_info "OK: Created src/test/resources/application-test.properties"
		fi
	fi
}
...
EOF
			log_info "OK: Created Application.kt"
		fi
...
EOF
			log_info "OK: Created HealthController.kt"
		fi
...
EOF
			log_info "OK: Created application.yml"
		fi
	fi
}
...
EOF
			log_info "OK: Created AndroidManifest.xml"
		fi
...
EOF
			log_info "OK: Created MainActivity.kt"
		fi
...
EOF
			log_info "OK: Created activity_main.xml"
		fi
...
EOF
			log_info "OK: Created strings.xml"
		fi
	fi
}
