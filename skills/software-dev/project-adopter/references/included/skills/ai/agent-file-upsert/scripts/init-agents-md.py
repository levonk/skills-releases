...
def init_project(project_root: Path, verbose: bool) -> None:
    ...
    if not created_any and sub_count == 0 and conv_count == 0:
        ...
        print(f"\nNext steps:")
        print(f"1. Fill in the TODO sections in AGENTS.md (Project Snapshot, Project Overview, JIT Index)")
        print(f"2. Fill in the TODO sections in .agents/knowledge/developer.md (Setup, Tech Stack, Workflow, Patterns, Boundaries)")
