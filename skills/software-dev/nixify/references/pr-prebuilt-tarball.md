...
<!-- Variant: Prebuilt Tarball Flake — default (flake_type=prebuilt_tarball, no devbox) -->
<!-- This is the default for prebuilt tarball flakes. Devbox is not included and not mentioned. -->
...
---
title: feat: add Nix flake support
---
