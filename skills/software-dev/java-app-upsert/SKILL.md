...
- [java-best-practices](../../../../knowledge/java-best-practices/overview.md) —
  Java/JVM best practices for containers, build tools, testing, and security.
- [container-best-practices](../../../../knowledge/container-best-practices/overview.md) —
  multi-stage builds, base image selection, and runtime hardening for Java apps.
- [devsecops-codeguard](../../../../knowledge/devsecops-codeguard/overview.md) —
