---
name: readme-upsert
description: Generate a project's README.md from scratch (greenfield) or update an existing one (brownfield). Use when creating a new project's README, onboarding a human to an existing codebase, or refreshing a stale README. Triggers on requests like "create README", "generate readme", "update README", "write project readme", or "set up readme for this repo". Do NOT trigger on AGENTS.md generation (use agent-file-upsert), general coding questions, or skill creation (use ai-upsert).
version: 1.2.0
