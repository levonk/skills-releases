...
skills.sh, and GitHub. Used by the ai-upsert research phase to find
existing skills before creating a new one.

Usage:
    uv run --script discover_skills.py "pdf rotation tool"
    ./scripts/skill/discover_skills.py "skill comparison" --verbose
    python scripts/skill/discover_skills.py "code review" --sources local,skills.sh
