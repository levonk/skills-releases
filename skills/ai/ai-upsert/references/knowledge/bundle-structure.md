...
> **Note (OKF v0.2):** The bundle-root `index.md` MAY carry an
> `okf_version: "0.2"` key in its frontmatter — the only place frontmatter is
> permitted in an `index.md` (§8, §12).
...
4. **Verify**: Validate OKF v0.2 conformance (see `okf-spec.md` — OKF v0.2
