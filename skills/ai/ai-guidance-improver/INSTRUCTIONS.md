...
- **Skills**: Run `skills/ai/ai-upsert/scripts/skill/discover_skills.py
...
```mermaid
flowchart TD
    Start([Invoke]) --> Mode{"Working with<br/>existing file?"}
    Mode -->|"Yes"| File["File-Based Mode"]
    Mode -->|"No"| Interactive["Interactive Mode"]

    File --> F1["1. Identify issues"]
    F1 --> F2["2. Prioritize<br/>High/Med/Low"]
    F2 --> F3["3. Apply improvements<br/>(frontmatter, PD, includes)"]
    F3 --> F4["4. Validate changes"]
    F4 --> F5["5. Document changes"]
    F5 --> DoneF([Deliver])

    Interactive --> I1["1. Analyze prompt"]
    I1 --> I2["2. Provide suggestions"]
    I2 --> I3["3. Offer improvements<br/>Critical/Important/Nice"]
    I3 --> I4["4. Iterate with user"]
    I4 --> I5["5. Finalize"]
    I5 --> DoneI([Deliver])
```
...
### Related Skills
- ai-upsert (complement) — For creating new AI guidance files
