...
* [Resilience Patterns](resilience-patterns.md) - Four classes of overload protection (concurrency limiters, connection poolers, circuit breakers, adaptive concurrency); choke-point principle; no universal library; service mesh + per-language library stack with cross-language matrix
