...
The existing standard (see [pnpm-nx-monorepo](https://github.com/levonk/skills-releases/blob/main/knowledge/typescript-monorepo-best-practices/pnpm-nx-monorepo.md))
