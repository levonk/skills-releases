...
A compounding knowledge base documenting practices for authentication,
authorization, payment processing, and multi-tenant data isolation in SaaS
applications. Each concept captures specific architectural decisions sourced
...
* [authorization-taxonomy](authorization-taxonomy.md) - Six-axis classification for authorization terminology (Administration, Model, Policy, Information, Decision, Enforcement); familiar labels (RBAC, ABAC, PBAC, MAC, DAC, ReBAC, ACL) each answer one axis
